...
public class Iniciar_Sesion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if ("admin".equals(jTextField1.getText())&& jTextField2.getText().equals("123")) {
            JOptionPane.showMessageDialog(null, "Bienvenido Administrador");
            Ventana_Administardor vA= new Ventana_Administardor();
            vA.show();
            dispose();
        }else if (CargaMasiva.lista.getCliente(jTextField2.getText(), jTextField1.getText())) {
             JOptionPane.showMessageDialog(null, "Bienvenido "+jTextField1);
